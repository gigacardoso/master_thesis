...
public class Approach1Nominal {
	...
	Exception {
		Approach1Nominal a = new Approach1Nominal();
...
//	}
	...
	private void writeTimes() throws IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path+"AP1_ALStimes_"+steps+"_Nominal.csv"));
		...
		prevL = Demo;
		for(long l:demoTime){
			out.write("demo"+demoIndex[i]+";"+(l-prevL)+"\n");
			prevL = l;
			i++;
		}
		out.write("\nClassifications\n\n");
