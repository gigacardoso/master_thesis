...
//		endNaive = System.currentTimeMillis();
		...
		Utils u = new Utils();
		u.metrics(matrix,classes_simb,"ALS",j,"Approach2_Nominal", steps, "NaiveBayes");
...
//				}
	...
	private void writeTimes() throws IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter(path+"AP2_ALStimes_"+steps+"_Nominal.csv"));
