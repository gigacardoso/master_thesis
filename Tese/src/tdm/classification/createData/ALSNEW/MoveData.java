...
public class MoveData {
	...
	public MoveData(String touse, String alternative, String approach1, String diagnosis, int steps) {
		super();
		this.toUse = touse;
	...
	private void MoveApproach2(boolean discret) {
		...
		try {
			...
			copyFile(new File(diagnosis + "DiagnoseDataReal.csv"), new File(approach2Out + File.separator + "DiagnoseDataReal.csv"));
...
//			copyFile(new File(toUse + steps+"VITALS_DATA.csv"), new File(approach2Out + File.separator + steps+"_VITALS_DATA.csv"));
			copyFile(new File(toUse + "Demo_Data.csv"), new File(approach2Out + File.separator + "Demo_Data.csv"));
		} catch (IOException e) {
			e.printStackTrace();
		}		
	}
...
//			copyFile(new File(approach1 + "PredictionDataWithDemo.csv"), new File(approach1Out + "PredictionDataWithDemo.csv"));
//			copyFile(new File(approach1 + "PredictionDataWithoutDemo.csv"), new File(approach1Out + "PredictionDataWithoutDemo.csv"));
//			copyFile(new File(toUse + steps+"VITALS_DATA.csv"), new File(approach1Out + File.separator + steps+"_VITALS_DATA.csv"));
			copyFile(new File(toUse + "Demo_Data.csv"), new File(approach1Out + File.separator + "Demo_Data.csv"));
		} catch (IOException e) {
			e.printStackTrace();
		}		
	}
