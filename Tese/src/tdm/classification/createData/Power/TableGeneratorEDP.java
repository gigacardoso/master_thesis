package tdm.classification.createData.Power;
...
public class TableGeneratorEDP {
	...
	public static void main(String[] args) {
		try {
			System.out.println("Generate Table EDP Numeric");
...
//			t.createSum(431); //max - 1431
			...
			n.generateEDPClassData(days, "diagnosis_discret.csv");
			//t.createDiscretDiagnosisData(5);
			TableGeneratorEDP t = new TableGeneratorEDP();
