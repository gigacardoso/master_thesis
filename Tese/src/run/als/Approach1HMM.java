...
public class Approach1HMM {
	...
	private String hmm = "C:\\PROACT_2013_08_27_ALL_FORMS\\hmm\\data\\run\\";
	...
	private static void hmm() throws IOException, FileNotFoundException,
		...
		u.metrics(matrix,classes_simb,"ALS",j,"Approach1(6,1)", steps, "NaiveBayes");
		a.ClassifyDataNominal(new J48());
		matrix = a.buildConfussionMatrix("J48");
		u.metrics(matrix,classes_simb,"ALS",j,"Approach1(6,1)", steps, "J48");
//		a.ClassifyDataNominal(new AdaBoostM1());
//		matrix = a.buildConfussionMatrix("AdaBoost");
//		u.metrics(matrix,classes_simb,"ALS",j,"Approach1(3,1)", steps, "AdaBoost");
//		a.ClassifyDataNominal(new Logistic());
//		matrix = a.buildConfussionMatrix("Logistic");
//		u.metrics(matrix,classes_simb,"ALS",j,"Approach1(3,1)", steps, "Logistic");
		a.ClassifyDataNominal(new RandomForest());
		matrix = a.buildConfussionMatrix("RandomForest");
		u.metrics(matrix,classes_simb,"ALS",j,"Approach1(6,1)", steps, "RandomForest");
