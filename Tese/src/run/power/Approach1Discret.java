...
public class Approach1Discret {
	...
	private  int steps = TableGeneratorDiscret.steps;
	...
	public static void main(String[] args){
		try {
			...
			System.out.println("Num Classes\t- " + TableGeneratorDiscret.num_classes);
			System.out.println("Days\t- " + TableGeneratorDiscret.days);
			
			Approach1Discret a = new Approach1Discret();
	...
	private void changeClassesInAttributes(String file) throws IOException{
		...
		String class_att = "@attribute PowerClass {";
		for (int i = 0; i < TableGeneratorDiscret.num_classes; i++) {
			class_att += "["+i+"],";
		}
...
//		System.out.println(class_att);
		while((line = in.readLine()) != null){
			if (line.contains("@attribute")){
				if(line.contains("@attribute PowerClass")){
					out.write(class_att+"\n");
				}else{
	...
	private  void buildConfussionMatrix(String method) throws FileNotFoundException, IOException {
		...
		String[] classes = new String[TableGeneratorDiscret.num_classes];
